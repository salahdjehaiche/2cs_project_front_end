<template>
    ...
    <div class="overflow-y-auto w-1/2 md:w-1/3 lg:w-64 fixed   md:top-0 md:left-0 h-screen lg:block bg-white border-r-2  z-30" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">
