<template>
    <div class="sticky top-0 z-40">
        <div
            class="w-full h-15 px-6 bg-white border-b-2 flex items-center justify-between"
        >
            <!-- left navbar -->
            <div class="flex">
                <!-- mobile hamburger -->
                ...
                <!--<div class="relative text-gray-600">
                  <input type="search" name="serch" placeholder="Search ..." class="bg-blue-100 h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-none">
